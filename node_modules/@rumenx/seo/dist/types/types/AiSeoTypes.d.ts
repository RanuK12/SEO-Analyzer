 ...
 */
export type AiSeoSuggestionType = 'technical' | 'content' | 'keywords' | 'structure' | 'performance' | 'accessibility' | 'meta' | 'schema' | 'links' | 'images';
/**
...
//# sourceMappingURL=AiSeoTypes.d.ts.map