...
export interface SeoMiddlewareOptions {
    ...
    metadataExtractor?: (req: SeoRequest, res: SeoResponse) => Promise<ContentMetadata> | ContentMetadata;
}
/**
 * Express.js specific types
 */
export declare namespace Express {
    interface ExpressSeoRequest extends SeoRequest {
        /** Express request object (when Express is available) */
        originalRequest?: unknown;
    }
    interface ExpressSeoResponse extends SeoResponse {
    ...
    interface SeoMiddleware {
        (req: unknown, res: unknown, next: unknown): void;
    }
    interface SeoExpressOptions extends SeoMiddlewareOptions {
 ...
 */
export declare namespace NextJs {
    interface NextSeoRequest extends SeoRequest {
        /** Next.js request object (when Next.js is available) */
        originalRequest?: unknown;
    }
    interface NextSeoResponse extends SeoResponse {
        /** Next.js response object (when Next.js is available) */
        originalResponse?: unknown;
    }
    interface SeoApiHandler {
        (req: unknown, res: unknown): Promise<void>;
    }
    interface SeoMiddleware {
        (req: unknown): Promise<unknown>;
    }
    interface SeoNextOptions extends SeoMiddlewareOptions {
 ...
 */
export declare namespace Fastify {
    interface FastifySeoRequest extends SeoRequest {
        /** Fastify request object (when Fastify is available) */
        originalRequest?: unknown;
    }
    interface FastifySeoResponse extends SeoResponse {
    ...
    interface SeoFastifyOptions extends SeoMiddlewareOptions {
        /** Plugin prefix */
        prefix?: string;
        /** Schema validation */
        schema?: boolean;
