 ...
 */
export function extractTextContentOptimized(html) {
    if (!html || typeof html !== 'string') {
        return '';
    }
 ...
 */
export function extractHeadingsOptimized(html) {
    if (!html || typeof html !== 'string') {
        return [];
    }
    const root = cachedParse(html);
 ...
 */
export function extractImagesOptimized(html, baseUrl) {
    if (!html || typeof html !== 'string') {
        return [];
    }
    const root = cachedParse(html);
    ...
    imgElements.forEach((element) => {
        ...
        const context = parent && parent instanceof HTMLElement ? extractNearbyTextOptimized(parent, element) : '';
 ...
 */
export function extractLinksOptimized(html, baseUrl) {
    if (!html || typeof html !== 'string') {
        return [];
    }
    const root = cachedParse(html);
 ...
 */
export function extractSeoMetricsOptimized(html) {
    if (!html || typeof html !== 'string') {
        return {
            titleTag: undefined,
...
export function extractKeywordsOptimized(text, minLength = 3, maxCount = 20) {
 ...
 */
export function calculateKeywordDensityOptimized(text, keywords) {
 ...
 */
export function clearOptimizedCaches() {
    parseCache.clear();
    urlCache.clear();
}
/**
