 ...
 */
import { extractTextContent, extractHeadings, extractImages, extractLinks, extractSeoMetrics, calculateReadingTime, countSentences, countParagraphs, extractKeywords, calculateKeywordDensity, getFrequentWords, } from '../utils/HtmlParser';
/**
...
export class ContentAnalyzer {
    ...
    extractSections(content) {
        ...
        patterns.forEach(pattern => {
            const regex = new RegExp(`<${pattern.selector}[^>]*>([\\s\\S]*?)<\\/${pattern.selector}>`, 'gi');
            let match;
