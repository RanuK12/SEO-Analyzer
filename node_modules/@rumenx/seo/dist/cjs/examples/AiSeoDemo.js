...
exports.mockSeoResult = exports.mockContentAnalysis = void 0;
exports.demonstrateAiSeoAnalyzer = demonstrateAiSeoAnalyzer;
const AiSeoAnalyzer_1 = require("../ai/AiSeoAnalyzer");
// Mock data for testing
const mockContentAnalysis = {
    rawContent: '<html><head><title>Test</title></head><body><p>This is a short test content with only a few words.</p></body></html>',
...
exports.mockContentAnalysis = mockContentAnalysis;
const mockSeoResult = {
    title: 'Test',
    description: '',
    keywords: ['test'],
...
exports.mockSeoResult = mockSeoResult;
/**
 * Demonstrate AI SEO analyzer functionality
 */
function demonstrateAiSeoAnalyzer() {
    console.log('🤖 AI-Powered SEO Analyzer Demo\n');
    // Initialize analyzer
    const analyzer = new AiSeoAnalyzer_1.AiSeoAnalyzer({
    ...
    analysis.suggestionGroups.forEach(group => {
        ...
        group.suggestions.forEach(suggestion => {
            ...
            console.log(`    Priority: ${suggestion.priority} | Impact: ${suggestion.impact} | Effort: ${suggestion.effort}`);
...
//# sourceMappingURL=AiSeoDemo.js.map