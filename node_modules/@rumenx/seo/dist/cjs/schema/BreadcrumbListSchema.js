...
exports.BreadcrumbListSchema = void 0;
 ...
 * ```
 */
class BreadcrumbListSchema extends BaseSchema_1.BaseSchema {
    constructor() {
        super(...arguments);
     ...
     * ```
     */
    static fromPath(baseUrl, currentPath, pathNames) {
        const schema = new BreadcrumbListSchema();
        // Add home
...
//# sourceMappingURL=BreadcrumbListSchema.js.map