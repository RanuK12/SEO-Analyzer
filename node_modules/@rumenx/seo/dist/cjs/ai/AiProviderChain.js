...
exports.AiProviderChain = void 0;
/**
 * AI provider fallback chain
 *
...
class AiProviderChain {
    ...
    async generate(prompt, options) {
        ...
        const availabilityChecks = await Promise.all(this.config.providers.map(async (p) => ({
            provider: p,
     ...
     */
    async generateWithTimeout(provider, prompt, options) {
     ...
     */
    updateProviderFailures(provider) {
...
exports.AiProviderChain = AiProviderChain;
//# sourceMappingURL=AiProviderChain.js.map