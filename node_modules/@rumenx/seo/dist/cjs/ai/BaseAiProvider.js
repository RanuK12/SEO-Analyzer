...
class BaseAiProvider {
     ...
     */
    async generateKeywords(context) {
...
Generate only the title text, no additional formatting or explanations.`;
     ...
     */
    buildDescriptionPrompt(context) {
        const analysis = context.analysis;
...
Generate only the alt text, no additional formatting or explanations.`;
    ...
    parseResponse(response) {
        ...
        const alternatives = content.includes(',') && content.length < 200
            ? content
                .split(',')
                .map(item => item.trim())
