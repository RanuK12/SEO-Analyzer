...
exports.DEFAULT_AI_SEO_TEMPLATES = void 0;
...
exports.getAvailableTemplateTypes = getAvailableTemplateTypes;
/**
 * Default AI SEO prompt templates
 */
exports.DEFAULT_AI_SEO_TEMPLATES = {
    technical: {
        ...
        examples: [
            {
                ...
                output: '{"suggestions": [{"title": "Reduce Keyword Density", "description": "Current keyword density of 4.2% appears unnatural and may trigger keyword stuffing penalties", "actionSteps": ["Reduce keyword mentions to 1-2%", "Use semantic variations", "Focus on natural language"], "impact": "Better user experience and search rankings", "effort": "medium", "priority": "high", "confidence": 0.88}]}',
            },
        ],
    },
    keywords: {
...
function validateTemplateVariables(template, variables) {
    ...
    const missingVariables = Array.from(requiredVariables).filter(variable => !(variable in variables));
    return {
...
function getTemplateByType(type) {
    return exports.DEFAULT_AI_SEO_TEMPLATES[type];
}
/**
 * Get all available template types
 */
function getAvailableTemplateTypes() {
    return Object.keys(exports.DEFAULT_AI_SEO_TEMPLATES);
}
//# sourceMappingURL=AiSeoPromptTemplates.js.map