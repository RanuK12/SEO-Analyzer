...
const ContentAnalyzer_1 = require("./ContentAnalyzer.js");
/**
...
class SeoManager {
    constructor(config, aiProvider) {
        ...
        Object.defineProperty(this, "contentAnalyzer", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        ...
        Object.defineProperty(this, "lastAnalysis", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: null
        });
        Object.defineProperty(this, "lastSeoResult", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: null
        ...
        this.config = config;
        this.contentAnalyzer = new ContentAnalyzer_1.ContentAnalyzer(config.baseUrl);
     ...
     */
    analyze(content, metadata = {}, options = {}) {
     ...
     */
    async generateSuggestions(analysis, type, options = {}) {
        if (!this.aiProvider) {
     ...
     * @throws {Error} If no analysis has been performed
     */
    generateDescription(maxLength = 160) {
        if (!this.lastAnalysis) {
     ...
     * @throws {Error} If no analysis has been performed
     */
    generateKeywords(maxKeywords = 10) {
        if (!this.lastAnalysis) {
    ...
    updateConfig(newConfig) {
        ...
        this.contentAnalyzer = new ContentAnalyzer_1.ContentAnalyzer(this.config.baseUrl);
        return this;
    }
    /**
     ...
     */
    generateRecommendations(analysis, _metadata) {
        ...
        else if (analysis.seoMetrics.titleTag.length < 30 ||
        ...
        else if (analysis.seoMetrics.metaDescription.length < 120 ||
        ...
        // Check images
        const imagesWithoutAlt = analysis.structure.images.filter(img => !img.currentAlt || img.currentAlt.length === 0);
     ...
     */
    calculateSeoScore(analysis, _recommendations) {
        const breakdown = {};
        ...
        const imagesWithAlt = analysis.structure.images.filter(img => img.currentAlt && img.currentAlt.length > 0);
        const imageAltRatio = analysis.structure.images.length > 0
     ...
     */
    buildAiPrompt(analysis, type, options) {
...
Generate ${options.contentLength ?? 'additional'} content suggestions that would improve the SEO value of this page.`;
     ...
     */
    parseAiResponse(response, _type) {
     ...
     */
    generateFallbackSuggestions(analysis, type) {
        switch (type) {
            case 'title':
                return [
...
//# sourceMappingURL=SeoManager.js.map