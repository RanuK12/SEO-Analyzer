...
exports.OptimizedContentAnalyzer = void 0;
const OptimizedHtmlParser_1 = require("../utils/OptimizedHtmlParser");
...
class OptimizedContentAnalyzer {
    constructor(baseUrl, enableCaching = true) {
        ...
        Object.defineProperty(this, "enableCaching", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
         ...
         */
        Object.defineProperty(this, "languageCache", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: new Map()
    ...
    analyze(content, metadata = {}) {
        ...
        const result = {
            ...
            paragraphCount: (0, HtmlParser_1.countParagraphs)(content),
     ...
     */
    analyzeFast(content, metadata = {}) {
        const startTime = performance.now();
        // Extract only essential data
        const textContent = (0, OptimizedHtmlParser_1.extractTextContentOptimized)(content);
        const wordCount = this.countWordsOptimized(textContent);
        const characterCount = textContent.length;
        const readingTime = (0, HtmlParser_1.calculateReadingTime)(textContent);
        // Minimal structure extraction
        const headings = (0, OptimizedHtmlParser_1.extractHeadingsOptimized)(content);
        const seoMetrics = (0, OptimizedHtmlParser_1.extractSeoMetricsOptimized)(content);
        // Basic keywords (top 10 only)
        const keywords = (0, OptimizedHtmlParser_1.extractKeywordsOptimized)(textContent, 3, 10);
        const processingTime = performance.now() - startTime;
        return {
            rawContent: content,
            textContent,
     ...
     */
    batchExtractHtmlData(content) {
        return [
            (0, OptimizedHtmlParser_1.extractTextContentOptimized)(content),
            (0, OptimizedHtmlParser_1.extractHeadingsOptimized)(content),
            (0, OptimizedHtmlParser_1.extractImagesOptimized)(content, this.baseUrl),
            (0, OptimizedHtmlParser_1.extractLinksOptimized)(content, this.baseUrl),
            (0, OptimizedHtmlParser_1.extractSeoMetricsOptimized)(content),
        ];
    }
    /**
    ...
    analyzeTextContent(textContent) {
        const wordCount = this.countWordsOptimized(textContent);
        const characterCount = textContent.length;
        const sentenceCount = (0, HtmlParser_1.countSentences)(textContent);
        const readingTime = (0, HtmlParser_1.calculateReadingTime)(textContent);
        // Parallel keyword processing
        const keywords = (0, OptimizedHtmlParser_1.extractKeywordsOptimized)(textContent);
        const keywordDensity = (0, OptimizedHtmlParser_1.calculateKeywordDensityOptimized)(textContent, keywords);
        const frequentWords = (0, HtmlParser_1.getFrequentWords)(textContent);
        return {
            wordCount,
            characterCount,
            sentenceCount,
     ...
     */
    extractSectionsOptimized(content) {
        const sections = [];
        ...
        sectionPatterns.forEach(({ type, pattern }) => {
            ...
            while ((match = pattern.exec(content)) !== null) {
                ...
                if (!sectionContent)
                    continue;
                const textContent = (0, OptimizedHtmlParser_1.extractTextContentOptimized)(sectionContent);
                const wordCount = this.countWordsOptimized(textContent);
                if (wordCount > 0) {
                    sections.push({
                        type,
     ...
     */
    createAnalysisKey(content, metadata) {
     ...
     */
    cacheAnalysisResult(content, metadata, result) {
        const cacheKey = this.createAnalysisKey(content, metadata);
        // Manage cache size
    ...
    clearCache() {
        ...
        (0, OptimizedHtmlParser_1.clearOptimizedCaches)();
    }
    /**
    ...
    getPerformanceStats() {
        return {
            ...
            htmlParserCache: (0, OptimizedHtmlParser_1.getCacheStats)(),
        };
    }
    /**
...
exports.OptimizedContentAnalyzer = OptimizedContentAnalyzer;
//# sourceMappingURL=OptimizedContentAnalyzer.js.map