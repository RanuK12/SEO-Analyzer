...
exports.extractSeoMetrics = extractSeoMetrics;
...
exports.getFrequentWords = getFrequentWords;
...
function extractImages(html, baseUrl) {
    ...
    imgElements.forEach((element) => {
        ...
        const context = parent && parent instanceof node_html_parser_1.HTMLElement ? extractNearbyText(parent, element) : '';
 ...
 */
function extractSeoMetrics(html) {
    if (!html || typeof html !== 'string') {
        return {
            titleTag: undefined,
 ...
 */
function getFrequentWords(text, maxCount = 20) {
    const words = text
        .toLowerCase()
        .split(/\s+/)
 ...
 */
function extractNearbyText(parent, target, maxLength = 200) {
    ...
    const afterText = allText.substring(targetIndex, Math.min(allText.length, targetIndex + maxLength / 2));
