...
exports.extractTextContentOptimized = extractTextContentOptimized;
exports.extractHeadingsOptimized = extractHeadingsOptimized;
exports.extractImagesOptimized = extractImagesOptimized;
exports.extractLinksOptimized = extractLinksOptimized;
exports.extractSeoMetricsOptimized = extractSeoMetricsOptimized;
exports.extractKeywordsOptimized = extractKeywordsOptimized;
exports.calculateKeywordDensityOptimized = calculateKeywordDensityOptimized;
exports.clearOptimizedCaches = clearOptimizedCaches;
 ...
 */
function cachedParse(html) {
    if (!html || typeof html !== 'string') {
        return (0, node_html_parser_1.parse)('');
    }
 ...
 */
function extractTextContentOptimized(html) {
    if (!html || typeof html !== 'string') {
        return '';
    }
 ...
 */
function extractHeadingsOptimized(html) {
    if (!html || typeof html !== 'string') {
        return [];
    }
    const root = cachedParse(html);
 ...
 */
function extractImagesOptimized(html, baseUrl) {
    if (!html || typeof html !== 'string') {
        return [];
    }
    const root = cachedParse(html);
    ...
    imgElements.forEach((element) => {
        ...
        const context = parent && parent instanceof node_html_parser_1.HTMLElement ? extractNearbyTextOptimized(parent, element) : '';
 ...
 */
function extractLinksOptimized(html, baseUrl) {
    if (!html || typeof html !== 'string') {
        return [];
    }
    const root = cachedParse(html);
 ...
 */
function extractSeoMetricsOptimized(html) {
    if (!html || typeof html !== 'string') {
        return {
            titleTag: undefined,
    ...
    // Extract H1 tags
    const h1Tags = h1Elements.map((el) => el.textContent.trim()).filter(Boolean);
...
function extractKeywordsOptimized(text, minLength = 3, maxCount = 20) {
 ...
 */
function calculateKeywordDensityOptimized(text, keywords) {
...
function resolveUrlOptimized(url, baseUrl) {
 ...
 */
function extractNearbyTextOptimized(parent, target, maxLength = 200) {
...
//# sourceMappingURL=OptimizedHtmlParser.js.map